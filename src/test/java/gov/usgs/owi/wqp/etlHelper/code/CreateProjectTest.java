...
public class CreateProjectTest extends BaseSpringTest {
	...
	@DatabaseSetups({
		...
		@DatabaseSetup(connection="wqp", value="classpath:/testData/storet/projectDim.xml")
	})
	...
	public void storetTest() {
		etlHelperCodeDao.createProject(STORET);
	}
